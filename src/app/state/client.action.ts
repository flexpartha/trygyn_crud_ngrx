...
// WITH ENTITY ADAPTER
export const updateClients = createAction(UPDATE_CLIENT_ACTION, props<{ client : Client}>());
export const updateClientsSuccess = createAction(UPDATE_CLIENT_SUCCESS, props<{ client : Update<Client>}>());

export const deleteClients = createAction(DELETE_CLIENT_ACTION,props<{id: any}>());

export const deleteClientsSuccess = createAction(DELETE_CLIENT_SUCCESS,props<{id : any}>());
